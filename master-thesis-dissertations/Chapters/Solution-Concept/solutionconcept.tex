...
\section{Software Core Architecture}
...
When the admin users have configured everything, they can start with the \ac{ui} experimentation using the \textit{Deployment} infrastructure. 
