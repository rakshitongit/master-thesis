...
Firstly in section \ref{background:section:uiprototyping}, we discuss \textit{\ac{ui} Prototyping} explaining the creation of a \ac{ui} simulation and testing for refining the design ideas and user requirements.
