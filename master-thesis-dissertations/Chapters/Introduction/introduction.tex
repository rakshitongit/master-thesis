...
More details about the DRs and DPs can be found in section \ref{design:section:soldesign}.
...
This thesis presents the\dots
\begin{figure}[htbp!]
    \centering
    \includegraphics[scale=0.2]{Structure_thesis.png}
