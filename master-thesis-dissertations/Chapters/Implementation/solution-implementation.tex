...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=0.308]{DFs/data-models.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=0.306]{DFs/experiments.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=0.3]{DFs/assign-tasks-to-users.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=0.3]{DFs/questionnaire.png}
...
It is important to note that the tool is a \ac{poc} rather than industry-ready. 
...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=0.54]{angular-architecture.png}
...
Our implementation is based on the \ac{mvc} architecture, which contains services and directives to talk to the server and some middleware to add a user token to every request to authenticate the user.
...
\begin{lstlisting}[language=JavaScript, caption=The Typescript File for the Middle Panel, label=listing:implementation:middle]
@Component({...})
...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=0.48]{lb4-architecture.png}
