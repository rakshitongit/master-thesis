...
\title{Development and Evaluation of a Model-Based UI Prototyping Experimentation Approach}
...
% Crest minimum should be 30mm.
\collegeshield{\includegraphics[width=0.6\textwidth]{Figs/CollegeShields/logo}}
...
\advisor{Dr. Sebastian Gottschalk}
...
%% Meta information
\subject{LaTeX} \keywords{{Informatik} {UI Prototyping} {MBSE} {UI Experimentation} {Master of Science Thesis} {Engineering} {Paderborn University}}
