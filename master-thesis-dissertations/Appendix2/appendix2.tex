...
\begin{table}[htbp!]
    ...
    \hline
    1 & Rapid software prototyping &  UI Prototyping Tool & \href{https://ieeexplore.ieee.org/abstract/document/183261}{Link} \\
    \hline 
    2 & Automating the software development process &  UI Prototyping Tool & \href{https://ieeexplore.ieee.org/abstract/document/5387726}{Link}\\
    \hline 
    3 & User interface prototyping & UI Prototyping Tool & \href{https://link.springer.com/content/pdf/10.1007/BFb0035808.pdf}{Link} \\
    \hline
    4 & Exploratory user interface design using scenarios and prototypes & UI Prototyping Tool & \href{https://books.google.com/books?hl=de&lr=&id=BTxOtt4X920C&oi=fnd&pg=PA191&dq=Exploratory+user+interface+design+using+scenarios+and+prototypes&ots=OGrm6tv1Vn&sig=j0UzKvk5rZaGp8js6BLOvUdEl94}{Link} \\
    \hline
